...
const Sidebar = () => {
    ...
    useEffect(() => {
        fetch('https://mighty-bastion-72908.herokuapp.com/isAdmin', {
            method: 'POST',
    ...
    return (
        <div className="sidebar d-flex flex-column justify-content-between" style={{ height: "100vh" }}>
            ...
            <ul className="list-unstyled">
                ...
                <li>
                    <Link to="/orderForm" className="sideStyle">
                        <FontAwesomeIcon icon={faShoppingCart} /> <span>Order</span>
                    </Link>
                </li>
                <li>
                    <Link to="/serviceList" className="sideStyle">
                ...
                <div>
                    ...
                    <li>
                        <Link to="addService" className="sideStyle">
                            <FontAwesomeIcon icon={faPlus} /> <span>Add Service</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="makeAdmin" className="sideStyle">
